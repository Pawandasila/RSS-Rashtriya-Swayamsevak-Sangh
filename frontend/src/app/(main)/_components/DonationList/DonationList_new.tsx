          ...
          <Table>
            ...
            <TableHeader>
              <TableRow className="bg-muted/50">
                <TableHead className="font-semibold text-foreground">दानदाता</TableHead>
                <TableHead className="font-semibold text-foreground">राशि</TableHead>
                <TableHead className="font-semibold text-foreground">स्थान</TableHead>
                <TableHead className="font-semibold text-foreground">भुगतान माध्यम</TableHead>
                <TableHead className="font-semibold text-foreground">समय</TableHead>
                <TableHead className="font-semibold text-foreground">संदेश</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
